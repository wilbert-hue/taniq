  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Global Industrial Rubber Market'}
              </h2>
            </div>
          </div>
        ...
        {/* Demo Data Notice */}
        <div className="mb-6 flex items-start gap-2.5 px-4 py-3 rounded-lg border border-amber-300 bg-amber-50 text-amber-800">
